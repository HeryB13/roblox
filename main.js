...
nadyaq.text = "Jangan Main kick ya, Hery Kick ya Bye!!!"
...
nadyasayang.text = "Jangan Ubah Gambar Dan Nama Group/Jangan Dimainin QR-nya -__- Hery Kick Yaa !"+"Cuma Admin Yang Bisa!"
...
let nadyasayang = new Message();
nadyasayang.to = operation.param1;
nadyasayang.text = "Kenapa Keluar Dia? Hery Invite Lagi Ya."
...
let nadyaq = new Message();
nadyaq.to = operation.param1;
nadyaq.text = "Hallo "+"Welcome Bot Test By:Hery"
...
let nadyaq = new Message();
nadyaq.to = operation.param1;
nadyaq.text = "Makasih udah di add Beta BOT By: Hery"
this._client.sendMessage(0,nadyaq);
}
...
let nadyaq = new Message();
nadyaq.to = operation.param1;
nadyaq.text = "Ketik Help Untuk Melihat Keyword"
...
this.command('Halo', ['halo disini Hery','kamu siapa?']);
this.command('Hi', ['hi disini Hery','kamu siapa?']);

this.command('Babi', ['mirip x sma kkak :v']);
this.command('Babik', ['mirip x sma kkak :v']);

this.command('Hery', ['apa kak?','ada yg bisa dibantu?']);
...
this.command('Pagi', ['selamat pagi :)']);
this.command('Morning', ['selamat pagi :)']);

this.command('Siang', ['siang juga, jangan lupa makan siang ya']);
this.command('Siank', ['siang juga :)']);

this.command('Sore', ['sore juga jangan lupa mandi ya :)']);

this.command('Tidur', ['Have A nice Dream']);

this.command('Malam', ['selamat malam:)']);
this.command('Night', ['selamat malam']);

this.command('O', ['o itu bulat']);
...
this.command('Bot lemot', ['jaringan lu yang lemot']);

this.command('Anjing', ['kok kasar, aku ga bisa di kasarin :(']);
...
this.command('Fak', ['SENSOR']);
this.command('Fuck', ['SENSOR']);
...
this.command('hery', ['ada apa?','ada yg bisa dibantu?']);
...
this.command('bot', ['ada apa?']);
this.command('bot hery', ['ada apa?']);
